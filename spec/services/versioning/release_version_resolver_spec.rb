...
RSpec.describe Versioning::ReleaseVersionResolver, type: :service do
  ...
  describe '#truth_table for next_version:' do
    [ #    releases                                  environment    action   expected_output    releases_description
      ...
      [['rc.1.v0.2.0'],                                'qa',       'hotfix', nil,               'there are no hotfix QA release'],
      [['rc.1.v0.2.0', 'rc.1.v1.5.1'],                 'qa',       'hotfix', 'rc.2.v1.5.1',     'there is a hotfix QA release'],
      [['rc.1.v0.2.0', 'v1.5.1'],                      'qa',       'hotfix', 'rc.1.v1.5.2',     'there is a hotfix STABLE release'],
      [['rc.1.v0.2.0', 'v1.5.0'],                      'qa',       'hotfix', 'rc.1.v1.5.1',     'there is a normal STABLE release'],
      [[],                                             'qa',       'update', 'rc.1.v1.0.0',     'empty list'],
      [['rc.1.v0.2.1', 'rc.1.v0.2.0'],                 'qa',       'update', 'rc.2.v0.2.0',     'there is a normal RC release'],
      [['v0.2.3', 'v0.2.0'],                           'qa',       'update', 'rc.1.v0.3.0',     'there is a normal STABLE release'],
      [['v0.2.3'],                                     'qa',       'update', 'rc.1.v1.0.0',     'there is a hotfix STABLE release'],
      [['rc.1.v0.2.3'],                                'qa',       'update', 'rc.1.v1.0.0',     'there is a hotfix RC release'],
      [['rc.1.v1.2.1', 'rc.1.v1.1.1', 'v1.2.0'],       'prod',     'hotfix', 'v1.2.1',          'there is a last hotfix QA release'],
      [['rc.1.v0.2.0', 'rc.1.v1.5.0', 'v1.6.0'],       'prod',     'hotfix', nil,               'there is no hotfix QA release'],
      [['rc.1.v0.2.0', 'v0.1.0'],                      'prod',     'update', 'v0.2.0',          'there is a last QA release'],
      [['rc.1.v0.1.1', 'v0.1.0'],                      'prod',     'update', nil,               'there is no QA release'],
      [['rc.1.v0.1.1', 'v0.1.1'],                      'prod',     'update', nil,               'there are only hotfix releases']
